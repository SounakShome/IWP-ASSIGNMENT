    ...
    <div className='py-4 sm:mx-auto my-auto max-w-screen-xl'>
      ...
      <div className="mt-4 flex flex-col rounded-lg p-4 shadow-lg">
          ...
          <div className="flex flex-row space-x-2">
            <div className="flex-1">
              ...
              <select className="w-full cursor-pointer rounded-md border border-gray-700  px-2 py-1" id="country">
                <option value="" defaultChecked disabled>Select a country</option>
        ...
        <div className="mt-4 flex justify-end">
          <button className="bg-white text-black rounded-md px-4 py-1 hover:bg-pink-500 hover:text-white transition-all duration-200 ease-out" type="submit">Submit</button>
        </div>
      </div>
      <div className="mt-4 flex flex-col rounded-lg p-4 shadow-lg">
